...
class AboutWindow:
    def __init__(self, root):
        ...
        CatDog Breed Classifier is a simple GUI application that uses deep learning 
        to classify images of cats and dogs. To use this application, follow these steps:

        1. Click the 'Browse' button to select an image.
        2. Click the 'Run Classifier' button to classify the selected image.
        3. The result will be displayed on the screen.

        Enjoy using CatDog Breed Classifier!
        """
